    ...
    return (
        <div className='flex justify-start gap-8 mt-4'>
            <div className='form-control'>
                <label className={`label cursor-pointer flex items-center gap-3 ${selectedGender === "male" ? "selected" : ""}`}>
            ...
            <div className='form-control'>
                <label className={`label cursor-pointer flex items-center gap-3 ${selectedGender === "female" ? "selected" : ""}`}>
